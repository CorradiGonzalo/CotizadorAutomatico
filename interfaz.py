...
class AntaresApp(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        # FOOTER
        self.footer = ctk.CTkFrame(self, height=100, fg_color="#1a1a1a")
        ...
        self.btn_pdf = ctk.CTkButton(self.footer, text="PDF", state="disabled", width=100, command=self.evento_pdf)
    ...
    def crear_inputs_datos(self, parent):
        ...
        self.entry_prod = self.input_box(parent, "Producto", 1, 0)
    ...
    def crear_inputs_config(self, parent):
        ...
        self.entry_indirectos = self.input_box(parent, "% Indirectos", 1, 0)
    ...
    def evento_calcular(self):
        try:
            ...
            datos = {
                'cantidad': self.get_float(self.entry_cant),
